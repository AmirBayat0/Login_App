...
public class signup extends Activity implements B4AActivity{
	...
	private void afterFirstLayout() {
        ...
        BA.LogInfo("** Activity (signup) Create, isFirst = " + isFirst + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"Lsign\")";
mostCurrent._activity.LoadLayout("Lsign",mostCurrent.activityBA);
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 47;BA.debugLine="If EditText1.Text == \"\" And EditText2.Text == \"\"";
if ((mostCurrent._edittext1.getText()).equals("") && (mostCurrent._edittext2.getText()).equals("") && (mostCurrent._edittext3.getText()).equals("") && (mostCurrent._edittext4.getText()).equals("") && (mostCurrent._edittext5.getText()).equals("")) { 
 //BA.debugLineNum = 48;BA.debugLine="Msgbox(\"You Must Fill in The Blanks\",\"Error Happ";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("You Must Fill in The Blanks"),BA.ObjectToCharSequence("Error Happened!"),mostCurrent.activityBA);
 }else if((mostCurrent._edittext1.getText()).equals("") == false && (mostCurrent._edittext2.getText()).equals("") == false && (mostCurrent._edittext3.getText()).equals("") == false && (mostCurrent._edittext4.getText()).equals("") == false && (mostCurrent._edittext5.getText()).equals("") == false && mostCurrent._checkbox1.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 51;BA.debugLine="Msgbox(\"Your registration is complete\",\"Congratu";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Your registration is complete"),BA.ObjectToCharSequence("Congratulations!"),mostCurrent.activityBA);
 //BA.debugLineNum = 52;BA.debugLine="Activity.Finish()";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 53;BA.debugLine="StartActivity(LoginPage)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._loginpage.getObject()));
 }else if((mostCurrent._edittext1.getText()).equals("") == false && (mostCurrent._edittext2.getText()).equals("") == false && (mostCurrent._edittext3.getText()).equals("") == false && (mostCurrent._edittext4.getText()).equals("") == false && (mostCurrent._edittext5.getText()).equals("") == false && mostCurrent._checkbox1.getChecked()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 56;BA.debugLine="Msgbox(\"you Must fill the checkbox\",\"Help\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("you Must fill the checkbox"),BA.ObjectToCharSequence("Help"),mostCurrent.activityBA);
 };
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 42;BA.debugLine="StartActivity(LoginPage)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._loginpage.getObject()));
...
mostCurrent._edittext4 = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Private EditText5 As EditText";
mostCurrent._edittext5 = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private CheckBox1 As CheckBox";
